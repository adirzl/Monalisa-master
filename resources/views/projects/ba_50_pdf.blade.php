<html>
    ...
    <body>
        <div class="title-pdf">
            ...
            <h4>Oversight Tahap 2 (50%)</h4>
        </div>
        <div class="title-head">
            <p>Berita Acara Oversight Tahap 2 (50%) - APBN 2020</p>
            <p>No.XXX/BA-Oversight/Tahap-50%/ALS/CEC/{{ Carbon\Carbon::now()->format('F') }}/2020</p>
        </div>
        <div class="title-desc">
            <p>Berita acara pelaksanaan Oversight Tahap 2 (Progres 50%) ini ditandatangani pada hari .....................  untuk mengkonfirmasi bahwa pelaksanaan Oversight Tahap 1 (Progres 0%) telah selesai dilaksanakan dengan rincian sebagai berikut :</p>
        </div>
        ...
        <div class="content">
            <table>
                ...
                <tr>
                    <td></td>
                    <td colspan="3">a.  Dinding (Cor/Buis Beton/Bata):</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;1) 50% = …….Titik | 2) 75% = …….Titik | 3) 100% = …….Titik</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">b. Dinding tanah (untuk Tangki Septik Fabrikan) :</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;1) 75% = …….Titik | 2) 100% = …….Titik</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">c. Tanah Urug dan Dipadatkan (Untuk Tangki Septik Fabrikan):</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp; 1) 25% = …….Titik | 2) 50% = …….Titik</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">d. Ketersediaan Material di Lapangan:</td>
                </tr>
                <tr>
                    <td></td>
                    <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp; 1) 0% = …….Titik | 2) 25% = …….Titik | 3) 50% = …….Titik | 4) 75% = …….Titik | 4) 100% = …….Titik </td>
                </tr>
                <tr>
                    <td></td>
        ...
        <div class="closing">
            <p>Data hasil Oversight Tahap 2 (Progres 50%) terlampir bersama berita acara ini.</p>
