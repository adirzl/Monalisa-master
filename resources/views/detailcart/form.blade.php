@php
    ...
    $title = 'create'; $method = 'post'; $action = 'detailcart.store';
    if ($segment !== 'create' ) { $title = 'edit'; $method = 'put'; $action = ['detailcart.update', $data->{$data->getKeyName()}]; }
@endphp

@extends('layouts.templates.default')
@section('title', ucwords('detailcart'))
