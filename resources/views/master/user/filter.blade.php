{{ Form::model($data, ['route' => 'user.filter', 'method' => 'post', 'class' => 'form-horizontal form-material form-data', 'autocomplete' => 'off']) }}
        <div class="row">
            @php
                $tempFOG = $fieldOnGrid;
    ...
    @include('...layouts.partials.admin.button_search', [ 'backLink' => 'user.index'])
{{ Form::close() }}
